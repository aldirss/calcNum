/*The lines 50 and 136 have been modified by Dr. Aldir Sousa*/
...
public abstract class Expr {
    ...
    /** Unary operator: secant */         public static final int SEC   = 114;
...
class UnaryExpr extends Expr {
	...
	case TAN:   return Math.tan(arg);
        case SEC: return 1/Math.cos(arg);/*Introduzed by Aldir Sousa*/
